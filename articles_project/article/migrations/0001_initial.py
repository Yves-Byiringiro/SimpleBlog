    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='article.Comment')),
        ...
        migrations.AddField(
            model_name='article',
            name='college',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.College'),
        ),
        migrations.AddField(
            model_name='article',
            name='dislikes',
